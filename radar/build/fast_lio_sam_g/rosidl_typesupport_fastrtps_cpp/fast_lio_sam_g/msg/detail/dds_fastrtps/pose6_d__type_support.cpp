...
#include "fast_lio_sam_g/msg/detail/pose6_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_fast_lio_sam_g
cdr_serialize(
  const fast_lio_sam_g::msg::Pose6D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fast_lio_sam_g::msg::Pose6D & ros_message)
{
  // Member: offset_time
  cdr >> ros_message.offset_time;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fast_lio_sam_g::msg::Pose6D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fast_lio_sam_g::msg::Pose6D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fast_lio_sam_g::msg::Pose6D *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_fast_lio_sam_g
const rosidl_message_type_support_t *
get_message_type_support_handle<fast_lio_sam_g::msg::Pose6D>()
{
  return &fast_lio_sam_g::msg::typesupport_fastrtps_cpp::_Pose6D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fast_lio_sam_g, msg, Pose6D)() {
  return &fast_lio_sam_g::msg::typesupport_fastrtps_cpp::_Pose6D__handle;
}
