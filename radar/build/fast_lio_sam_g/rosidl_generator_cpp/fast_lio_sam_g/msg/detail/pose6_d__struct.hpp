...
#ifndef FAST_LIO_SAM_G__MSG__DETAIL__POSE6_D__STRUCT_HPP_
#define FAST_LIO_SAM_G__MSG__DETAIL__POSE6_D__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__fast_lio_sam_g__msg__Pose6D __attribute__((deprecated))
#else
# define DEPRECATED__fast_lio_sam_g__msg__Pose6D __declspec(deprecated)
#endif
...
struct Pose6D_
{
  ...
  // pointer types
  using RawPtr =
    fast_lio_sam_g::msg::Pose6D_<ContainerAllocator> *;
  using ConstRawPtr =
    const fast_lio_sam_g::msg::Pose6D_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<fast_lio_sam_g::msg::Pose6D_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<fast_lio_sam_g::msg::Pose6D_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      fast_lio_sam_g::msg::Pose6D_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<fast_lio_sam_g::msg::Pose6D_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<fast_lio_sam_g::msg::Pose6D_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<fast_lio_sam_g::msg::Pose6D_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<fast_lio_sam_g::msg::Pose6D_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__fast_lio_sam_g__msg__Pose6D
    std::shared_ptr<fast_lio_sam_g::msg::Pose6D_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__fast_lio_sam_g__msg__Pose6D
    std::shared_ptr<fast_lio_sam_g::msg::Pose6D_<ContainerAllocator> const>
...
using Pose6D =
  fast_lio_sam_g::msg::Pose6D_<std::allocator<void>>;
...
#endif  // FAST_LIO_SAM_G__MSG__DETAIL__POSE6_D__STRUCT_HPP_
