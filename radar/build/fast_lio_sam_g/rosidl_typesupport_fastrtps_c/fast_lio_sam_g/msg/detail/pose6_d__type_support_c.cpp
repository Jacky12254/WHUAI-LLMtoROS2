...
#include "fast_lio_sam_g/msg/detail/pose6_d__rosidl_typesupport_fastrtps_c.h"
...
#include "fast_lio_sam_g/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Pose6D__ros_msg_type = fast_lio_sam_g__msg__Pose6D;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fast_lio_sam_g
size_t get_serialized_size_fast_lio_sam_g__msg__Pose6D(
  const void * untyped_ros_message,
...
static uint32_t _Pose6D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fast_lio_sam_g__msg__Pose6D(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fast_lio_sam_g
size_t max_serialized_size_fast_lio_sam_g__msg__Pose6D(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fast_lio_sam_g__msg__Pose6D;
    is_plain =
      (
...
static size_t _Pose6D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fast_lio_sam_g__msg__Pose6D(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fast_lio_sam_g, msg, Pose6D)() {
